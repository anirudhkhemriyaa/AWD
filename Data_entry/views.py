...
def home(request):
    ...
    if request.method == "POST":
        ...
        # pass history id to celery
        import_data_task.delay(complete_path, model_name, history.id)

        messages.success(request, 'Your data is in processing, you will be notified')
        return redirect("home")

    return render(request, "home.html", {"models": all_models})
